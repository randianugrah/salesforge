                ...
                <header className="relative pt-32 pb-32 overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-6 text-center">
                        ...
                        <div className="relative mx-auto max-w-5xl rounded-[2.5rem] overflow-hidden border border-white/10 shadow-[0_0_50px_-10px_rgba(168,85,247,0.3)] bg-black/50 aspect-video flex items-center justify-center">
                            <img src={`https://image.pollinations.ai/prompt/${encodeURIComponent((content.image_prompt || salesPage.product_name) + ' sleek modern high-tech aesthetic cinematic lighting')}?width=1200&height=675&nologo=true`} alt={salesPage.product_name} className="w-full h-full object-cover" />
                        </div>
                    </div>
                </header>
        ...
        <div className="bg-[#fafafa] text-gray-900 font-serif selection:bg-rose-100">
            <header className="pt-32 pb-32 text-center max-w-4xl mx-auto px-6">
                ...
                <div className="w-full max-w-4xl mx-auto aspect-[4/3] bg-gray-100 mt-10 overflow-hidden shadow-2xl">
                    <img src={`https://image.pollinations.ai/prompt/${encodeURIComponent((content.image_prompt || salesPage.product_name) + ' minimalist aesthetic fashion editorial high end Vogue style')}?width=1200&height=900&nologo=true`} alt={salesPage.product_name} className="w-full h-full object-cover grayscale-[20%]" />
                </div>
            </header>
            ...
            <header className="bg-blue-900 text-white pt-32 pb-48 text-center px-6">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="w-full max-w-3xl mx-auto aspect-[21/9] bg-blue-800 rounded-xl mt-10 overflow-hidden shadow-2xl border-4 border-blue-400/20">
                        <img src={`https://image.pollinations.ai/prompt/${encodeURIComponent((content.image_prompt || salesPage.product_name) + ' professional corporate office environment premium')}?width=1200&height=500&nologo=true`} alt={salesPage.product_name} className="w-full h-full object-cover opacity-90 mix-blend-luminosity" />
                    </div>
                </div>
            </header>
        ...
        <div className="bg-[#fffdf7] text-orange-950 font-sans selection:bg-orange-200">
            <header className="pt-32 pb-32 text-center max-w-4xl mx-auto px-6">
                ...
                <div className="w-full max-w-2xl mx-auto aspect-square bg-orange-100 rounded-full mt-8 overflow-hidden shadow-[0_20px_50px_-10px_rgba(234,88,12,0.3)] border-8 border-white">
                    <img src={`https://image.pollinations.ai/prompt/${encodeURIComponent((content.image_prompt || salesPage.product_name) + ' appetizing food photography bright colors highly detailed menu photo')}?width=800&height=800&nologo=true`} alt={salesPage.product_name} className="w-full h-full object-cover" />
                </div>
            </header>
